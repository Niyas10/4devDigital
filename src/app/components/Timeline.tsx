...
export default function AboutSection() {
  return (
    <section className="py-[20px] md:pt-[50px]  lg:py-[80px] from-background to-secondary/20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-[30px] md:text-[40px] lg:text-[50px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 sm:text-4xl">About Us</h2>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
        >
          <div className="p-[20px] md:p-[30px] bg-[#2E2E2E] bg-opacity-30 backdrop-blur-lg rounded-3xl border-[1px] border-purple-500">
          ...
          <div className="lg:col-span-2 p-[20px] md:p-[30px] bg-[#2E2E2E] bg-opacity-30 backdrop-blur-lg rounded-3xl border-[1px] border-purple-500">
